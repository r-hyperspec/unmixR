...
Since there are 300 channels, we'll ask for three endmembers so we can visualize the results.  As above, we'll expand the X axis and the data is actually contained within a 2-simplex.
