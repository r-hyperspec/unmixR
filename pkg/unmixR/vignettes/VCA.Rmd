...
#    can see the figures are drawn.  Not sure when this behavior
...
```{r getEMs}
# Get the endmembers
results1 <- vca05mod(dM1$data, p = 3)
str(results1)
